...
const BannerComponent = () => {
  return (
    ...
    <div>
     ...
     <div  className="bg-[rgba(0,0,0,0.8)]  md:w-[25%] w-[100%]  md:h-[100vh] h-[50vh] flex flex-col ">
     ...
     <div className=" flex md:justify-end justify-start md:items-end  items-start md:mt-24  flex-col">
